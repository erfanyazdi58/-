...
jQuery(function ($) {
   ...
   ====================================== */
    ...
    if ($("#typewriting").length) {
        ...
        typewriter.typeString('راهی برای رسیدن به موفقیت').pauseFor(2000).deleteAll()
            .typeString('شیوه ای نوین برای موفقیت').pauseFor(2000).deleteAll()
            .typeString('متدی بی نظیر برای موفقیت').start();
    }
    ...
    $("#submit_btn").click(function () {
        ...
        if (proceed) {
            ...
            $.post('contact.php', post_data, function (response) {
                ...
                $("#submit_btn span").text('ارسال');
                $("#submit_btn i").addClass('d-none');

            }, 'json');

        } else {
            output = '<div class="alert-danger" style="padding:10px; margin-bottom:30px;">لطفا تمامی فیلدها را پر نمایید.</div>';
            $("#result").hide().html(output).slideDown();
